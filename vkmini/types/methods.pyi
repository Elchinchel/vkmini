...
class account:
    ...
    async def getAppPermissions(self, *, user_id: int, **kwargs: Any) -> 'responses.account_getAppPermissions_response':
        '''Gets settings of the user in this application.'''

    async def getBanned(self, *, offset: Optional[int] = None, count: int = 20, **kwargs: Any) -> 'responses.account_getBanned_response':
    ...
    async def getCounters(self, *, filter: Optional[filter_enum] = None, user_id: Optional[int] = None, **kwargs: Any) -> 'responses.account_getCounters_response':
        '''Returns non-null values of user counters.'''

    fields_enum = Literal['country', 'https_required', 'own_posts_default', 'no_wall_replies', 'intro', 'lang']
    async def getInfo(self, *, fields: Optional[fields_enum] = None, **kwargs: Any) -> 'responses.account_getInfo_response':
    ...
    async def registerDevice(self, *, token: str, device_id: str, device_model: Optional[str] = None, device_year: Optional[int] = None, system_version: Optional[str] = None, settings: Optional[str] = None, sandbox: bool = 0, **kwargs: Any) -> 'responses.base_ok_response':
    ...
    async def setInfo(self, *, name: Optional[Literal['intro', 'no_wall_replies', 'own_posts_default']] = None, value: Optional[str] = None, **kwargs: Any) -> 'responses.base_ok_response':
        '''Allows to edit the current account info.'''

    async def setNameInMenu(self, *, user_id: int, name: Optional[str] = None, **kwargs: Any) -> 'responses.base_ok_response':
        '''Sets an application screen name (up to 17 characters), that is shown to the user in the left menu.'''

    async def setOffline(self, **kwargs: Any) -> 'responses.base_ok_response':
        '''Marks a current user as offline.'''

    async def setOnline(self, *, voip: Optional[bool] = None, **kwargs: Any) -> 'responses.base_ok_response':
        '''Marks the current user as online for 15 minutes.'''

    async def setPushSettings(self, *, device_id: str, settings: Optional[str] = None, key: Optional[str] = None, value: Optional[Union[str, str]] = None, **kwargs: Any) -> 'responses.base_ok_response':
    ...
    async def unregisterDevice(self, *, device_id: Optional[str] = None, sandbox: bool = 0, **kwargs: Any) -> 'responses.base_ok_response':
...
class ads:
    ...
    async def checkLink(self, *, account_id: int, link_type: Literal['community', 'post', 'application', 'video', 'site'], link_url: str, campaign_id: Optional[int] = None, **kwargs: Any) -> 'responses.ads_checkLink_response':
    ...
    async def getAds(self, *, account_id: int, ad_ids: Optional[str] = None, campaign_ids: Optional[str] = None, client_id: Optional[int] = None, include_deleted: Optional[bool] = None, only_deleted: Optional[bool] = None, limit: Optional[int] = None, offset: Optional[int] = None, **kwargs: Any) -> 'responses.ads_getAds_response':
        '''Returns number of ads.'''

    async def getAdsLayout(self, *, account_id: int, client_id: Optional[int] = None, include_deleted: Optional[bool] = None, only_deleted: Optional[bool] = None, campaign_ids: Optional[str] = None, ad_ids: Optional[str] = None, limit: Optional[int] = None, offset: Optional[int] = None, **kwargs: Any) -> 'responses.ads_getAdsLayout_response':
        '''Returns descriptions of ad layouts.'''

    async def getAdsTargeting(self, *, account_id: int, ad_ids: Optional[str] = None, campaign_ids: Optional[str] = None, client_id: Optional[int] = None, include_deleted: Optional[bool] = None, limit: Optional[int] = None, offset: Optional[int] = None, **kwargs: Any) -> 'responses.ads_getAdsTargeting_response':
    ...
    async def getCampaigns(self, *, account_id: int, client_id: Optional[int] = None, include_deleted: Optional[bool] = None, campaign_ids: Optional[str] = None, fields: Optional[fields_enum] = None, **kwargs: Any) -> 'responses.ads_getCampaigns_response':
    ...
    async def getStatistics(self, *, account_id: int, ids_type: Literal['ad', 'campaign', 'client', 'office'], ids: str, period: Literal['day', 'month', 'overall'], date_from: str, date_to: str, stats_fields: Optional[stats_fields_enum] = None, **kwargs: Any) -> 'responses.ads_getStatistics_response':
        '''Returns statistics of performance indicators for ads, campaigns, clients or the whole account.'''

    async def getSuggestions(self, *, section: Literal['countries', 'regions', 'cities', 'districts', 'stations', 'streets', 'schools', 'interests', 'positions', 'group_types', 'religions', 'browsers'], ids: Optional[str] = None, q: Optional[str] = None, country: Optional[int] = None, cities: Optional[str] = None, lang: Optional[Literal['ru', 'ua', 'en']] = None, **kwargs: Any) -> 'responses.ads_getSuggestions_response':
        '''Returns a set of auto-suggestions for various targeting parameters.'''

    async def getTargetGroups(self, *, account_id: int, client_id: Optional[int] = None, extended: Optional[bool] = None, **kwargs: Any) -> 'responses.ads_getTargetGroups_response':
        '''Returns a list of target groups.'''

    async def getTargetingStats(self, *, account_id: int, link_url: str, client_id: Optional[int] = None, criteria: Optional[str] = None, ad_id: Optional[int] = None, ad_format: Optional[Literal[1, 2, 3, 4, 7, 8, 9, 10]] = None, ad_platform: Optional[str] = None, ad_platform_no_wall: Optional[str] = None, ad_platform_no_ad_network: Optional[str] = None, publisher_platforms: Optional[str] = None, link_domain: Optional[str] = None, need_precise: Optional[bool] = None, impressions_limit_period: Optional[int] = None, **kwargs: Any) -> 'responses.ads_getTargetingStats_response':
        '''Returns the size of targeting audience, and also recommended values for CPC and CPM.'''

    async def getUploadURL(self, *, ad_format: Literal[1, 2, 3, 4, 7], icon: Optional[int] = None, **kwargs: Any) -> 'responses.ads_getUploadURL_response':
...
class adsweb:
    ...
    async def getAdUnits(self, *, office_id: int, sites_ids: Optional[str] = None, ad_units_ids: Optional[str] = None, fields: Optional[str] = None, limit: int = None, offset: int = 0, **kwargs: Any) -> 'responses.adsweb_getAdUnits_response': ...

    async def getFraudHistory(self, *, office_id: int, sites_ids: Optional[str] = None, limit: int = None, offset: int = 0, **kwargs: Any) -> 'responses.adsweb_getFraudHistory_response': ...

    async def getSites(self, *, office_id: int, sites_ids: Optional[str] = None, fields: Optional[str] = None, limit: int = None, offset: int = 0, **kwargs: Any) -> 'responses.adsweb_getSites_response': ...

    async def getStatistics(self, *, office_id: int, ids_type: str, ids: str, period: str, date_from: str, date_to: str, fields: Optional[str] = None, page_id: Optional[str] = None, limit: int = None, **kwargs: Any) -> 'responses.adsweb_getStatistics_response': ...
...
class appWidgets:
    ...
    async def getImagesById(self, *, images: Union[str, str], **kwargs: Any) -> 'responses.appWidgets_getImagesById_response':
...
class apps:
    ...
    async def get(self, *, app_id: Optional[int] = None, app_ids: Optional[Union[str, str]] = None, fields: Optional[Union['objects.users_fields', str]] = None, name_case: Optional[Literal['nom', 'gen', 'dat', 'acc', 'ins', 'abl']] = None, platform: Literal['android', 'ios', 'web', 'winphone'] = 'web', extended: bool = 0, return_friends: bool = 0, **kwargs: Any) -> 'responses.apps_get_response':
        '''Returns applications data.'''

    async def getCatalog(self, *, sort: Optional[Literal['popular_today', 'visitors', 'create_date', 'growth_rate', 'popular_week']] = None, offset: Optional[int] = None, platform: Optional[str] = None, extended: Optional[bool] = None, return_friends: Optional[bool] = None, fields: Optional[Union['objects.users_fields', str]] = None, name_case: Optional[str] = None, q: Optional[str] = None, genre_id: Optional[int] = None, filter: Optional[Literal['favorite', 'featured', 'installed', 'new']] = None, count: int = 100, **kwargs: Any) -> 'responses.apps_getCatalog_response':
        '''Returns a list of applications (apps) available to users in the App Catalog.'''

    async def getFriendsList(self, *, fields: Optional[Union['objects.users_fields', str]] = None, extended: bool = 0, count: int = 20, offset: int = 0, type: Literal['invite', 'request'] = 'invite', **kwargs: Any) -> 'responses.apps_getFriendsList_response':
        '''Creates friends list for requests and invites in current app.'''

    async def getLeaderboard(self, *, type: Literal['level', 'points', 'score'], extended: bool = 0, **kwargs: Any) -> 'responses.apps_getLeaderboard_response':
    ...
    async def getScore(self, *, user_id: int, **kwargs: Any) -> 'responses.apps_getScore_response':
    ...
    async def sendRequest(self, *, user_id: int, text: Optional[str] = None, name: Optional[str] = None, key: Optional[str] = None, separate: Optional[bool] = None, type: Literal['invite', 'request'] = 'request', **kwargs: Any) -> 'responses.apps_sendRequest_response':
...
class board:
    ...
    async def addTopic(self, *, group_id: int, title: str, text: Optional[str] = None, from_group: Optional[bool] = None, attachments: Optional[Union[str, str]] = None, **kwargs: Any) -> 'responses.board_addTopic_response':
        '''Creates a new topic on a community's discussion board.'''

    async def closeTopic(self, *, group_id: int, topic_id: int, **kwargs: Any) -> 'responses.base_ok_response':
        '''Closes a topic on a community's discussion board so that comments cannot be posted.'''

    async def createComment(self, *, group_id: int, topic_id: int, message: Optional[str] = None, attachments: Optional[Union[str, str]] = None, from_group: Optional[bool] = None, sticker_id: Optional[int] = None, guid: Optional[str] = None, **kwargs: Any) -> 'responses.board_createComment_response':
    ...
    async def editComment(self, *, group_id: int, topic_id: int, comment_id: int, message: Optional[str] = None, attachments: Optional[Union[str, str]] = None, **kwargs: Any) -> 'responses.base_ok_response':
    ...
    async def getComments(self, *, group_id: int, topic_id: int, need_likes: Optional[bool] = None, start_comment_id: Optional[int] = None, offset: Optional[int] = None, extended: Optional[bool] = None, sort: Optional[Literal['asc', 'desc']] = None, count: int = 20, **kwargs: Any) -> 'responses.board_getComments_response':
        '''Returns a list of comments on a topic on a community's discussion board.'''

    async def getTopics(self, *, group_id: int, topic_ids: Optional[Union[int, str]] = None, order: Optional[Literal[1, 2, -1, -2, 0]] = None, offset: Optional[int] = None, extended: Optional[bool] = None, preview: Optional[Literal[1, 2, 0]] = None, count: int = 40, preview_length: int = 90, **kwargs: Any) -> 'responses.board_getTopics_response':
...
class database:
    ...
    async def getCities(self, *, country_id: int, region_id: Optional[int] = None, q: Optional[str] = None, need_all: Optional[bool] = None, offset: Optional[int] = None, count: int = 100, **kwargs: Any) -> 'responses.database_getCities_response':
    ...
    async def getCountries(self, *, need_all: Optional[bool] = None, code: Optional[str] = None, offset: Optional[int] = None, count: int = 100, **kwargs: Any) -> 'responses.database_getCountries_response':
    ...
    async def getMetroStations(self, *, city_id: int, offset: Optional[int] = None, count: int = 100, extended: bool = False, **kwargs: Any) -> 'responses.database_getMetroStations_response':
    ...
    async def getRegions(self, *, country_id: int, q: Optional[str] = None, offset: Optional[int] = None, count: int = 100, **kwargs: Any) -> 'responses.database_getRegions_response':
        '''Returns a list of regions.'''

    async def getSchoolClasses(self, *, country_id: Optional[int] = None, **kwargs: Any) -> 'responses.database_getSchoolClasses_response':
    ...
    async def getUniversities(self, *, q: Optional[str] = None, country_id: Optional[int] = None, city_id: Optional[int] = None, offset: Optional[int] = None, count: int = 100, **kwargs: Any) -> 'responses.database_getUniversities_response':
...
class docs:
    ...
    async def edit(self, *, owner_id: int, doc_id: int, title: str, tags: Optional[Union[str, str]] = None, **kwargs: Any) -> 'responses.base_ok_response':
        '''Edits a document.'''

    async def get(self, *, count: Optional[int] = None, offset: Optional[int] = None, owner_id: Optional[int] = None, type: Literal[0, 1, 2, 3, 4, 5, 6, 7, 8] = 0, return_tags: bool = False, **kwargs: Any) -> 'responses.docs_get_response':
        '''Returns detailed information about user or community documents.'''

    async def getById(self, *, docs: Union[str, str], return_tags: bool = False, **kwargs: Any) -> 'responses.docs_getById_response':
        '''Returns information about documents by their IDs.'''

    async def getMessagesUploadServer(self, *, peer_id: Optional[int] = None, type: Literal['audio_message', 'doc', 'graffiti'] = 'doc', **kwargs: Any) -> 'responses.base_getUploadServer_response':
        '''Returns the server address for document upload.'''

    async def getTypes(self, *, owner_id: int, **kwargs: Any) -> 'responses.docs_getTypes_response':
    ...
    async def save(self, *, file: str, title: Optional[str] = None, tags: Optional[str] = None, return_tags: bool = False, **kwargs: Any) -> 'responses.docs_save_response':
        '''Saves a document after [vk.com/dev/upload_files_2|uploading it to a server].'''

    async def search(self, *, q: str, search_own: Optional[bool] = None, offset: Optional[int] = None, return_tags: Optional[bool] = None, count: int = 20, **kwargs: Any) -> 'responses.docs_search_response':
        '''Returns a list of documents matching the search criteria.'''

class donut:
    def __getattr__(self, __name: str) -> __VkMethod: ...

    async def getFriends(self, *, owner_id: int, fields: Optional[Union[str, str]] = None, offset: int = 0, count: int = 10, **kwargs: Any) -> 'responses.groups_getMembers_fields_response': ...
...
class fave:
    ...
    async def get(self, *, item_type: Optional[Literal['article', 'clip', 'link', 'narrative', 'page', 'podcast', 'post', 'product', 'video', 'youla_product']] = None, tag_id: Optional[int] = None, offset: Optional[int] = None, fields: Optional[str] = None, is_from_snackbar: Optional[bool] = None, extended: bool = False, count: int = 50, **kwargs: Any) -> 'responses.fave_get_response': ...
    ...
    async def setTags(self, *, item_type: Optional[Literal['article', 'clip', 'link', 'narrative', 'page', 'podcast', 'post', 'product', 'video', 'youla_product']] = None, item_owner_id: Optional[int] = None, item_id: Optional[int] = None, tag_ids: Optional[Union[int, str]] = None, link_id: Optional[str] = None, link_url: Optional[str] = None, **kwargs: Any) -> 'responses.base_ok_response': ...
...
class friends:
    ...
    async def add(self, *, user_id: Optional[int] = None, text: Optional[str] = None, follow: Optional[bool] = None, **kwargs: Any) -> 'responses.friends_add_response':
    ...
    async def areFriends(self, *, user_ids: Union[int, str], need_sign: Optional[bool] = None, extended: Optional[bool] = None, **kwargs: Any) -> 'responses.friends_areFriends_response':
    ...
    @overload
    async def get(self, *, fields: Union['objects.users_fields', str], user_id: Optional[int] = None, order: Optional[Literal['hints', 'random', 'mobile', 'name', 'smart']] = None, list_id: Optional[int] = None, offset: Optional[int] = None, name_case: Optional[Literal['nom', 'gen', 'dat', 'acc', 'ins', 'abl']] = None, ref: Optional[str] = None, count: int = 5000, **kwargs: Any) -> 'responses.friends_get_fields_response': ...
    @overload
    async def get(self, *, user_id: Optional[int] = None, order: Optional[Literal['hints', 'random', 'mobile', 'name', 'smart']] = None, list_id: Optional[int] = None, offset: Optional[int] = None, fields: Optional[None] = None, name_case: Optional[Literal['nom', 'gen', 'dat', 'acc', 'ins', 'abl']] = None, ref: Optional[str] = None, count: int = 5000, **kwargs: Any) -> 'responses.friends_get_response':
        '''Returns a list of user IDs or detailed information about a user's friends.'''

    async def getAppUsers(self, **kwargs: Any) -> 'responses.friends_getAppUsers_response':
        '''Returns a list of IDs of the current user's friends who installed the application.'''

    async def getByPhones(self, *, phones: Optional[Union[str, str]] = None, fields: Optional[Union['objects.users_fields', str]] = None, **kwargs: Any) -> 'responses.friends_getByPhones_response':
        '''Returns a list of the current user's friends whose phone numbers, validated or specified in a profile, are in a given list.'''

    async def getLists(self, *, user_id: Optional[int] = None, return_system: Optional[bool] = None, **kwargs: Any) -> 'responses.friends_getLists_response':
        '''Returns a list of the user's friend lists.'''

    async def getMutual(self, *, source_uid: Optional[int] = None, target_uid: Optional[int] = None, target_uids: Optional[Union[int, str]] = None, order: Optional[str] = None, count: Optional[int] = None, offset: Optional[int] = None, **kwargs: Any) -> 'responses.friends_getMutual_response':
        '''Returns a list of user IDs of the mutual friends of two users.'''

    async def getOnline(self, *, user_id: Optional[int] = None, list_id: Optional[int] = None, online_mobile: Optional[bool] = None, order: Optional[str] = None, count: Optional[int] = None, offset: Optional[int] = None, **kwargs: Any) -> 'responses.friends_getOnline_response':
        '''Returns a list of user IDs of a user's friends who are online.'''

    async def getRecent(self, *, count: int = 100, **kwargs: Any) -> 'responses.friends_getRecent_response':
        '''Returns a list of user IDs of the current user's recently added friends.'''

    async def getRequests(self, *, offset: Optional[int] = None, extended: Optional[bool] = None, need_mutual: Optional[bool] = None, out: Optional[bool] = None, sort: Optional[Literal[0, 1, 2]] = None, suggested: Optional[bool] = None, ref: Optional[str] = None, fields: Optional[Union['objects.users_fields', str]] = None, count: int = 100, need_viewed: bool = 0, **kwargs: Any) -> 'responses.friends_getRequests_response':
        '''Returns information about the current user's incoming and outgoing friend requests.'''

    filter_enum = Literal['mutual', 'contacts', 'mutual_contacts']
    async def getSuggestions(self, *, filter: Optional[filter_enum] = None, offset: Optional[int] = None, fields: Optional[Union['objects.users_fields', str]] = None, name_case: Optional[Literal['nom', 'gen', 'dat', 'acc', 'ins', 'abl']] = None, count: int = 500, **kwargs: Any) -> 'responses.friends_getSuggestions_response':
        '''Returns a list of profiles of users whom the current user may know.'''

    async def search(self, *, user_id: int, q: Optional[str] = None, fields: Optional[Union['objects.users_fields', str]] = None, offset: Optional[int] = None, name_case: Literal['Nom', 'Gen', 'Dat', 'Acc', 'Ins', 'Abl'] = 'Nom', count: int = 20, **kwargs: Any) -> 'responses.friends_search_response':
...
class groups:
    ...
    async def addAddress(self, *, group_id: int, title: str, address: str, country_id: int, city_id: int, latitude: float, longitude: float, additional_address: Optional[str] = None, metro_id: Optional[int] = None, phone: Optional[str] = None, timetable: Optional[str] = None, is_main_address: Optional[bool] = None, work_info_status: 'objects.groups_address_work_info_status' = 'no_information', **kwargs: Any) -> 'responses.groups_addAddress_response': ...
    ...
    async def ban(self, *, group_id: int, owner_id: Optional[int] = None, end_date: Optional[int] = None, reason: Optional[int] = None, comment: Optional[str] = None, comment_visible: Optional[bool] = None, **kwargs: Any) -> 'responses.base_ok_response': ...

    async def create(self, *, title: str, description: Optional[str] = None, public_category: Optional[int] = None, public_subcategory: Optional[int] = None, subtype: Optional[Literal[1, 2, 3, 4]] = None, type: Literal['event', 'group', 'public'] = 'group', **kwargs: Any) -> 'responses.groups_create_response':
    ...
    async def editManager(self, *, group_id: int, user_id: int, role: Optional['objects.groups_group_role'] = None, is_contact: Optional[bool] = None, contact_position: Optional[str] = None, contact_phone: Optional[str] = None, contact_email: Optional[str] = None, **kwargs: Any) -> 'responses.base_ok_response':
        '''Allows to add, remove or edit the community manager.'''

    async def enableOnline(self, *, group_id: int, **kwargs: Any) -> 'responses.base_ok_response': ...

    async def get(self, *, user_id: Optional[int] = None, extended: Optional[bool] = None, filter: Optional[Union['objects.groups_filter', str]] = None, fields: Optional[Union['objects.groups_fields', str]] = None, offset: Optional[int] = None, count: Optional[int] = None, **kwargs: Any) -> 'responses.groups_get_response':
        '''Returns a list of the communities to which a user belongs.'''

    async def getAddresses(self, *, group_id: int, address_ids: Optional[Union[int, str]] = None, latitude: Optional[float] = None, longitude: Optional[float] = None, offset: Optional[int] = None, fields: Optional[Union['objects.addresses_fields', str]] = None, count: int = 10, **kwargs: Any) -> 'responses.groups_getAddresses_response':
    ...
    async def getById(self, *, group_ids: Optional[Union[str, str]] = None, group_id: Optional[str] = None, fields: Optional[Union['objects.groups_fields', str]] = None, **kwargs: Any) -> 'responses.groups_getById_object_legacy_response':
    ...
    async def getCatalog(self, *, category_id: Optional[int] = None, subcategory_id: Optional[int] = None, **kwargs: Any) -> 'responses.groups_getCatalog_response':
        '''Returns communities list for a catalog category.'''

    async def getCatalogInfo(self, *, extended: bool = 0, subcategories: bool = 0, **kwargs: Any) -> 'responses.groups_getCatalogInfo_response':
        '''Returns categories list for communities catalog'''

    async def getInvitedUsers(self, *, group_id: int, offset: Optional[int] = None, fields: Optional[Union['objects.users_fields', str]] = None, name_case: Optional[Literal['nom', 'gen', 'dat', 'acc', 'ins', 'abl']] = None, count: int = 20, **kwargs: Any) -> 'responses.groups_getInvitedUsers_response':
        '''Returns invited users list of a community'''

    async def getInvites(self, *, offset: Optional[int] = None, extended: Optional[bool] = None, count: int = 20, **kwargs: Any) -> 'responses.groups_getInvites_response':
    ...
    @overload
    async def getMembers(self, *, fields: Union['objects.users_fields', str], group_id: Optional[str] = None, offset: Optional[int] = None, filter: Optional[Literal['friends', 'unsure', 'managers', 'donut']] = None, sort: Literal['id_asc', 'id_desc', 'time_asc', 'time_desc'] = 'id_asc', count: int = 1000, **kwargs: Any) -> 'responses.groups_getMembers_fields_response': ...
    @overload
    async def getMembers(self, *, group_id: Optional[str] = None, offset: Optional[int] = None, fields: Optional[None] = None, filter: Optional[Literal['friends', 'unsure', 'managers', 'donut']] = None, sort: Literal['id_asc', 'id_desc', 'time_asc', 'time_desc'] = 'id_asc', count: int = 1000, **kwargs: Any) -> 'responses.groups_getMembers_response':
    ...
    @overload
    async def getRequests(self, *, group_id: int, offset: Optional[int] = None, fields: Optional[None] = None, count: int = 20, **kwargs: Any) -> 'responses.groups_getRequests_response':
        '''Returns a list of requests to the community.'''

    async def getSettings(self, *, group_id: int, **kwargs: Any) -> 'responses.groups_getSettings_response':
    ...
    async def invite(self, *, group_id: int, user_id: int, **kwargs: Any) -> 'responses.base_ok_response':
        '''Allows to invite friends to the community.'''

    async def isMember(self, *, group_id: str, user_id: Optional[int] = None, user_ids: Optional[Union[int, str]] = None, extended: Optional[bool] = None, **kwargs: Any) -> 'responses.groups_isMember_response':
        '''Returns information specifying whether a user is a member of a community.'''

    async def join(self, *, group_id: Optional[int] = None, not_sure: Optional[str] = None, **kwargs: Any) -> 'responses.base_ok_response':
    ...
    async def search(self, *, q: str, type: Optional[Literal['group', 'page', 'event']] = None, country_id: Optional[int] = None, city_id: Optional[int] = None, future: Optional[bool] = None, market: Optional[bool] = None, sort: Optional[Literal[0, 1, 2, 3, 4, 5]] = None, offset: Optional[int] = None, count: int = 20, **kwargs: Any) -> 'responses.groups_search_response':
    ...
    async def setSettings(self, *, group_id: int, messages: Optional[bool] = None, bots_capabilities: Optional[bool] = None, bots_start_button: Optional[bool] = None, bots_add_to_chat: Optional[bool] = None, **kwargs: Any) -> 'responses.base_ok_response': ...
...
class likes:
    ...
    async def add(self, *, type: 'objects.likes_type', item_id: int, owner_id: Optional[int] = None, access_key: Optional[str] = None, **kwargs: Any) -> 'responses.likes_add_response':
        '''Adds the specified object to the 'Likes' list of the current user.'''

    async def delete(self, *, type: 'objects.likes_type', item_id: int, owner_id: Optional[int] = None, access_key: Optional[str] = None, **kwargs: Any) -> 'responses.likes_delete_response':
        '''Deletes the specified object from the 'Likes' list of the current user.'''

    async def getList(self, *, type: 'objects.likes_type', owner_id: Optional[int] = None, item_id: Optional[int] = None, page_url: Optional[str] = None, filter: Optional[Literal['likes', 'copies']] = None, extended: Optional[bool] = None, offset: Optional[int] = None, count: Optional[int] = None, skip_own: Optional[bool] = None, friends_only: Literal[0, 1, 2, 3] = 0, **kwargs: Any) -> 'responses.likes_getList_response':
...
class market:
    ...
    async def add(self, *, owner_id: int, name: str, description: str, category_id: int, price: Optional[float] = None, old_price: Optional[float] = None, deleted: Optional[bool] = None, main_photo_id: Optional[int] = None, photo_ids: Optional[Union[int, str]] = None, url: Optional[str] = None, dimension_width: Optional[int] = None, dimension_height: Optional[int] = None, dimension_length: Optional[int] = None, weight: Optional[int] = None, sku: Optional[str] = None, **kwargs: Any) -> 'responses.market_add_response':
        '''Ads a new item to the market.'''

    async def addAlbum(self, *, owner_id: int, title: str, photo_id: Optional[int] = None, main_album: Optional[bool] = None, is_hidden: Optional[bool] = None, **kwargs: Any) -> 'responses.market_addAlbum_response':
    ...
    async def createComment(self, *, owner_id: int, item_id: int, message: Optional[str] = None, attachments: Optional[Union[str, str]] = None, from_group: Optional[bool] = None, reply_to_comment: Optional[int] = None, sticker_id: Optional[int] = None, guid: Optional[str] = None, **kwargs: Any) -> 'responses.market_createComment_response':
    ...
    async def deleteComment(self, *, owner_id: int, comment_id: int, **kwargs: Any) -> 'responses.market_deleteComment_response':
        '''Deletes an item's comment'''

    async def edit(self, *, owner_id: int, item_id: int, name: str, description: str, category_id: int, price: Optional[float] = None, deleted: Optional[bool] = None, main_photo_id: Optional[int] = None, photo_ids: Optional[Union[int, str]] = None, url: Optional[str] = None, **kwargs: Any) -> 'responses.base_ok_response':
        '''Edits an item.'''

    async def editAlbum(self, *, owner_id: int, album_id: int, title: str, photo_id: Optional[int] = None, main_album: Optional[bool] = None, is_hidden: Optional[bool] = None, **kwargs: Any) -> 'responses.base_ok_response':
        '''Edits a collection of items'''

    async def editComment(self, *, owner_id: int, comment_id: int, message: Optional[str] = None, attachments: Optional[Union[str, str]] = None, **kwargs: Any) -> 'responses.base_ok_response':
        '''Chages item comment's text'''

    async def editOrder(self, *, user_id: int, order_id: int, merchant_comment: Optional[str] = None, status: Optional[int] = None, track_number: Optional[str] = None, payment_status: Optional[Literal['not_paid', 'paid', 'returned']] = None, delivery_price: Optional[int] = None, width: Optional[int] = None, length: Optional[int] = None, height: Optional[int] = None, weight: Optional[int] = None, **kwargs: Any) -> 'responses.base_ok_response':
        '''Edit order'''

    async def get(self, *, owner_id: int, offset: Optional[int] = None, extended: Optional[bool] = None, date_from: Optional[str] = None, date_to: Optional[str] = None, need_variants: Optional[bool] = None, with_disabled: Optional[bool] = None, album_id: int = 0, count: int = 100, **kwargs: Any) -> 'responses.market_get_response':
    ...
    async def getById(self, *, item_ids: Union[str, str], extended: Optional[bool] = None, **kwargs: Any) -> 'responses.market_getById_response':
        '''Returns information about market items by their ids.'''

    async def getCategories(self, *, offset: Optional[int] = None, count: int = 10, **kwargs: Any) -> 'responses.market_getCategories_response':
        '''Returns a list of market categories.'''

    async def getComments(self, *, owner_id: int, item_id: int, need_likes: Optional[bool] = None, start_comment_id: Optional[int] = None, extended: Optional[bool] = None, fields: Optional[Union['objects.users_fields', str]] = None, offset: int = 0, count: int = 20, sort: Literal['asc', 'desc'] = 'asc', **kwargs: Any) -> 'responses.market_getComments_response':
        '''Returns comments list for an item.'''

    async def getGroupOrders(self, *, group_id: int, offset: int = 0, count: int = 10, **kwargs: Any) -> 'responses.market_getGroupOrders_response':
        '''Get market orders'''

    async def getOrderById(self, *, order_id: int, user_id: Optional[int] = None, extended: Optional[bool] = None, **kwargs: Any) -> 'responses.market_getOrderById_response':
        '''Get order'''
    ...
    async def getOrders(self, *, extended: Optional[bool] = None, date_from: Optional[str] = None, date_to: Optional[str] = None, offset: int = 0, count: int = 10, **kwargs: Any) -> 'responses.market_getOrders_response': ...
    ...
    async def restoreComment(self, *, owner_id: int, comment_id: int, **kwargs: Any) -> 'responses.market_restoreComment_response':
        '''Restores a recently deleted comment'''

    async def search(self, *, owner_id: int, album_id: Optional[int] = None, q: Optional[str] = None, price_from: Optional[int] = None, price_to: Optional[int] = None, offset: Optional[int] = None, status: Optional[Union[int, str]] = None, need_variants: Optional[bool] = None, sort: Literal[0, 1, 2, 3] = 0, rev: Literal[0, 1] = 1, count: int = 20, extended: bool = '0', **kwargs: Any) -> 'responses.market_search_response':
        '''Searches market items in a community's catalog'''

    async def searchItems(self, *, q: str, category_id: Optional[int] = None, price_from: Optional[int] = None, price_to: Optional[int] = None, offset: int = 0, count: int = 30, sort_by: Literal[1, 2, 3] = 3, sort_direction: Literal[0, 1] = 1, **kwargs: Any) -> 'responses.market_search_response': ...
...
class messages:
    ...
    async def createChat(self, *, user_ids: Optional[Union[int, str]] = None, title: Optional[str] = None, group_id: Optional[int] = None, **kwargs: Any) -> 'responses.messages_createChat_response':
        '''Creates a chat with several participants.'''

    async def delete(self, *, message_ids: Optional[Union[int, str]] = None, spam: Optional[bool] = None, group_id: Optional[int] = None, peer_id: Optional[int] = None, cmids: Optional[Union[int, str]] = None, delete_for_all: bool = False, **kwargs: Any) -> 'responses.messages_delete_response':
    ...
    async def edit(self, *, peer_id: int, message: Optional[str] = None, lat: Optional[float] = None, long: Optional[float] = None, attachment: Optional[str] = None, keep_forward_messages: Optional[bool] = None, keep_snippets: Optional[bool] = None, group_id: Optional[int] = None, message_id: Optional[int] = None, conversation_message_id: Optional[int] = None, template: Optional[str] = None, keyboard: Optional[str] = None, dont_parse_links: bool = False, disable_mentions: bool = False, **kwargs: Any) -> 'responses.messages_edit_response':
        '''Edits the message.'''

    async def editChat(self, *, chat_id: int, title: Optional[str] = None, **kwargs: Any) -> 'responses.base_ok_response':
        '''Edits the title of a chat.'''

    async def getByConversationMessageId(self, *, peer_id: int, conversation_message_ids: Union[int, str], extended: Optional[bool] = None, fields: Optional[Union['objects.users_fields', str]] = None, group_id: Optional[int] = None, **kwargs: Any) -> 'responses.messages_getByConversationMessageId_response':
        '''Returns messages by their IDs within the conversation.'''

    async def getById(self, *, message_ids: Union[int, str], extended: Optional[bool] = None, fields: Optional[Union['objects.users_fields', str]] = None, group_id: Optional[int] = None, preview_length: int = 0, **kwargs: Any) -> 'responses.messages_getById_response':
    ...
    async def getConversationMembers(self, *, peer_id: int, fields: Optional[Union['objects.users_fields', str]] = None, group_id: Optional[int] = None, **kwargs: Any) -> 'responses.messages_getConversationMembers_response':
        '''Returns a list of IDs of users participating in a chat.'''

    async def getConversations(self, *, extended: Optional[bool] = None, start_message_id: Optional[int] = None, fields: Optional[Union['objects.base_user_group_fields', str]] = None, group_id: Optional[int] = None, offset: int = 0, count: int = 20, filter: Literal['all', 'archive', 'important', 'unanswered', 'unread'] = 'all', **kwargs: Any) -> 'responses.messages_getConversations_response':
        '''Returns a list of the current user's conversations.'''

    async def getConversationsById(self, *, peer_ids: Union[int, str], extended: Optional[bool] = None, fields: Optional[Union['objects.base_user_group_fields', str]] = None, group_id: Optional[int] = None, **kwargs: Any) -> 'responses.messages_getConversationsById_response':
        '''Returns conversations by their IDs'''

    async def getHistory(self, *, offset: Optional[int] = None, user_id: Optional[int] = None, peer_id: Optional[int] = None, start_message_id: Optional[int] = None, rev: Optional[Literal[1, 0]] = None, extended: Optional[bool] = None, fields: Optional[Union['objects.users_fields', str]] = None, group_id: Optional[int] = None, count: int = 20, **kwargs: Any) -> 'responses.messages_getHistory_response':
        '''Returns message history for the specified user or group chat.'''

    async def getHistoryAttachments(self, *, peer_id: int, start_from: Optional[str] = None, photo_sizes: Optional[bool] = None, fields: Optional[Union['objects.users_fields', str]] = None, group_id: Optional[int] = None, preserve_order: Optional[bool] = None, media_type: Literal['audio', 'audio_message', 'doc', 'graffiti', 'link', 'market', 'photo', 'share', 'video', 'wall'] = 'photo', count: int = 30, max_forwards_level: int = 45, **kwargs: Any) -> 'responses.messages_getHistoryAttachments_response':
        '''Returns media files from the dialog or group chat.'''

    async def getImportantMessages(self, *, offset: Optional[int] = None, start_message_id: Optional[int] = None, preview_length: Optional[int] = None, fields: Optional[Union['objects.base_user_group_fields', str]] = None, extended: Optional[bool] = None, group_id: Optional[int] = None, count: int = 20, **kwargs: Any) -> 'responses.messages_getImportantMessages_response':
        '''Returns a list of user's important messages.'''

    async def getIntentUsers(self, *, intent: Literal['confirmed_notification', 'non_promo_newsletter', 'promo_newsletter'], subscribe_id: Optional[int] = None, extended: Optional[bool] = None, name_case: Optional[Union[str, str]] = None, fields: Optional[Union[str, str]] = None, offset: int = 0, count: int = 20, **kwargs: Any) -> 'responses.messages_getIntentUsers_response': ...

    async def getInviteLink(self, *, peer_id: int, group_id: Optional[int] = None, reset: bool = False, **kwargs: Any) -> 'responses.messages_getInviteLink_response': ...

    async def getLastActivity(self, *, user_id: int, **kwargs: Any) -> 'responses.messages_getLastActivity_response':
        '''Returns a user's current status and date of last activity.'''

    async def getLongPollHistory(self, *, ts: Optional[int] = None, pts: Optional[int] = None, preview_length: Optional[int] = None, onlines: Optional[bool] = None, max_msg_id: Optional[int] = None, group_id: Optional[int] = None, lp_version: Optional[int] = None, credentials: Optional[bool] = None, fields: List['objects.users_fields'] = 'photo,photo_medium_rec,sex,online,screen_name', events_limit: int = 1000, msgs_limit: int = 200, last_n: int = 0, **kwargs: Any) -> 'responses.messages_getLongPollHistory_response':
        '''Returns updates in user's private messages.'''

    async def getLongPollServer(self, *, need_pts: Optional[bool] = None, group_id: Optional[int] = None, lp_version: int = 0, **kwargs: Any) -> 'responses.messages_getLongPollServer_response':
    ...
    async def markAsAnsweredConversation(self, *, peer_id: int, group_id: Optional[int] = None, answered: bool = 1, **kwargs: Any) -> 'responses.base_ok_response':
        '''Marks and unmarks conversations as unanswered.'''

    async def markAsImportant(self, *, important: Optional[int] = None, message_ids: List[int] = [], **kwargs: Any) -> 'responses.messages_markAsImportant_response':
        '''Marks and unmarks messages as important (starred).'''

    async def markAsImportantConversation(self, *, peer_id: int, group_id: Optional[int] = None, important: bool = 1, **kwargs: Any) -> 'responses.base_ok_response':
        '''Marks and unmarks conversations as important.'''

    async def markAsRead(self, *, peer_id: Optional[int] = None, start_message_id: Optional[int] = None, group_id: Optional[int] = None, mark_conversation_as_read: Optional[bool] = None, message_ids: List[int] = [], **kwargs: Any) -> 'responses.base_ok_response':
        '''Marks messages as read.'''

    async def pin(self, *, peer_id: int, message_id: Optional[int] = None, conversation_message_id: Optional[int] = None, **kwargs: Any) -> 'responses.messages_pin_response':
        '''Pin a message.'''
    ...
    async def restore(self, *, message_id: int, group_id: Optional[int] = None, **kwargs: Any) -> 'responses.base_ok_response':
        '''Restores a deleted message.'''

    async def search(self, *, q: Optional[str] = None, peer_id: Optional[int] = None, date: Optional[int] = None, extended: Optional[bool] = None, fields: Optional[Union[str, str]] = None, group_id: Optional[int] = None, preview_length: int = 0, offset: int = 0, count: int = 20, **kwargs: Any) -> 'responses.messages_search_response':
        '''Returns a list of the current user's private messages that match search criteria.'''

    async def searchConversations(self, *, q: Optional[str] = None, extended: Optional[bool] = None, fields: Optional[Union['objects.users_fields', str]] = None, group_id: Optional[int] = None, count: int = 20, **kwargs: Any) -> 'responses.messages_searchConversations_response':
        '''Returns a list of the current user's conversations that match search criteria.'''

    async def send(self, *, user_id: Optional[int] = None, random_id: Optional[int] = None, peer_id: Optional[int] = None, peer_ids: Optional[Union[int, str]] = None, domain: Optional[str] = None, chat_id: Optional[int] = None, user_ids: Optional[Union[int, str]] = None, message: Optional[str] = None, lat: Optional[float] = None, long: Optional[float] = None, attachment: Optional[str] = None, reply_to: Optional[int] = None, forward_messages: Optional[Union[int, str]] = None, forward: Optional['objects.messages_forward'] = None, sticker_id: Optional[int] = None, group_id: Optional[int] = None, keyboard: Optional['objects.messages_keyboard'] = None, template: Optional[str] = None, payload: Optional[str] = None, content_source: Optional[str] = None, subscribe_id: Optional[int] = None, dont_parse_links: bool = False, disable_mentions: bool = False, intent: Literal['account_update', 'bot_ad_invite', 'bot_ad_promo', 'confirmed_notification', 'customer_support', 'default', 'game_notification', 'moderated_newsletter', 'non_promo_newsletter', 'promo_newsletter', 'purchase_update'] = 'default', **kwargs: Any) -> 'responses.messages_send_response':
        '''Sends a message.'''
...
class newsfeed:
    ...
    async def addBan(self, *, user_ids: Optional[Union[int, str]] = None, group_ids: Optional[Union[int, str]] = None, **kwargs: Any) -> 'responses.base_ok_response':
    ...
    async def getLists(self, *, list_ids: Optional[Union[int, str]] = None, extended: bool = 0, **kwargs: Any) -> 'responses.newsfeed_getLists_response':
    ...
    async def getRecommended(self, *, start_time: Optional[int] = None, end_time: Optional[int] = None, max_photos: Optional[int] = None, start_from: Optional[str] = None, count: Optional[int] = None, fields: Optional[Union['objects.base_user_group_fields', str]] = None, **kwargs: Any) -> 'responses.newsfeed_getRecommended_response':
        ''', Returns a list of newsfeeds recommended to the current user.'''

    async def getSuggestedSources(self, *, offset: Optional[int] = None, shuffle: Optional[bool] = None, fields: Optional[Union['objects.base_user_group_fields', str]] = None, count: int = 20, **kwargs: Any) -> 'responses.newsfeed_getSuggestedSources_response':
        '''Returns communities and users that current user is suggested to follow.'''

    async def ignoreItem(self, *, type: 'objects.newsfeed_ignore_item_type', owner_id: int = 0, item_id: int = 0, **kwargs: Any) -> 'responses.base_ok_response':
        '''Hides an item from the newsfeed.'''

    async def saveList(self, *, title: str, list_id: Optional[int] = None, source_ids: Optional[Union[int, str]] = None, no_reposts: Optional[bool] = None, **kwargs: Any) -> 'responses.newsfeed_saveList_response':
        '''Creates and edits user newsfeed lists'''

    async def search(self, *, q: Optional[str] = None, extended: Optional[bool] = None, latitude: Optional[float] = None, longitude: Optional[float] = None, start_time: Optional[int] = None, end_time: Optional[int] = None, start_from: Optional[str] = None, fields: Optional[Union['objects.base_user_group_fields', str]] = None, count: int = 30, **kwargs: Any) -> 'responses.newsfeed_search_response':
        '''Returns search results by statuses.'''

    async def unignoreItem(self, *, type: 'objects.newsfeed_ignore_item_type', owner_id: int, item_id: int, track_code: Optional[str] = None, **kwargs: Any) -> 'responses.base_ok_response':
        '''Returns a hidden item to the newsfeed.'''

    async def unsubscribe(self, *, type: Literal['note', 'photo', 'post', 'topic', 'video'], item_id: int, owner_id: Optional[int] = None, **kwargs: Any) -> 'responses.base_ok_response':
        '''Unsubscribes the current user from specified newsfeeds.'''

class notes:
    def __getattr__(self, __name: str) -> __VkMethod: ...

    async def add(self, *, title: str, text: str, privacy_view: List[str] = 'all', privacy_comment: List[str] = 'all', **kwargs: Any) -> 'responses.notes_add_response':
    ...
    async def edit(self, *, note_id: int, title: str, text: str, privacy_view: List[str] = 'all', privacy_comment: List[str] = 'all', **kwargs: Any) -> 'responses.base_ok_response':
    ...
    async def getById(self, *, note_id: int, owner_id: Optional[int] = None, need_wiki: bool = 0, **kwargs: Any) -> 'responses.notes_getById_response':
...
class notifications:
    ...
    async def get(self, *, start_from: Optional[str] = None, filters: Optional[filters_enum] = None, start_time: Optional[int] = None, end_time: Optional[int] = None, count: int = 30, **kwargs: Any) -> 'responses.notifications_get_response':
        '''Returns a list of notifications about other users' feedback to the current user's wall posts.'''

    async def markAsViewed(self, **kwargs: Any) -> 'responses.notifications_markAsViewed_response':
        '''Resets the counter of new notifications about other users' feedback to the current user's wall posts.'''

    async def sendMessage(self, *, user_ids: Union[int, str], message: str, fragment: Optional[str] = None, group_id: Optional[int] = None, random_id: Optional[int] = None, sending_mode: Literal['delayed', 'delayed_push', 'immediately'] = 'immediately', **kwargs: Any) -> 'responses.notifications_sendMessage_response': ...

class orders:
    def __getattr__(self, __name: str) -> __VkMethod: ...

    async def cancelSubscription(self, *, user_id: int, subscription_id: int, pending_cancel: bool = 0, **kwargs: Any) -> 'responses.orders_cancelSubscription_response': ...

    async def changeState(self, *, order_id: int, action: Literal['cancel', 'charge', 'refund'], app_order_id: Optional[int] = None, test_mode: Optional[bool] = None, **kwargs: Any) -> 'responses.orders_changeState_response':
        '''Changes order status.'''

    async def get(self, *, test_mode: Optional[bool] = None, offset: int = 0, count: int = 100, **kwargs: Any) -> 'responses.orders_get_response':
        '''Returns a list of orders.'''

    async def getAmount(self, *, user_id: int, votes: Union[str, str], **kwargs: Any) -> 'responses.orders_getAmount_response': ...

    async def getById(self, *, order_id: Optional[int] = None, order_ids: Optional[Union[int, str]] = None, test_mode: Optional[bool] = None, **kwargs: Any) -> 'responses.orders_getById_response':
    ...
    async def updateSubscription(self, *, user_id: int, subscription_id: int, price: int, **kwargs: Any) -> 'responses.orders_updateSubscription_response': ...
...
class pages:
    ...
    async def get(self, *, owner_id: Optional[int] = None, page_id: Optional[int] = None, site_preview: Optional[bool] = None, title: Optional[str] = None, need_source: Optional[bool] = None, need_html: Optional[bool] = None, **kwargs: Any) -> 'responses.pages_get_response':
    ...
    async def getVersion(self, *, version_id: int, group_id: Optional[int] = None, user_id: Optional[int] = None, need_html: Optional[bool] = None, **kwargs: Any) -> 'responses.pages_getVersion_response':
...
class photos:
    ...
    async def createAlbum(self, *, title: str, group_id: Optional[int] = None, description: Optional[str] = None, upload_by_admins_only: Optional[bool] = None, comments_disabled: Optional[bool] = None, privacy_view: List[str] = 'all', privacy_comment: List[str] = 'all', **kwargs: Any) -> 'responses.photos_createAlbum_response':
        '''Creates an empty photo album.'''

    async def createComment(self, *, photo_id: int, owner_id: Optional[int] = None, message: Optional[str] = None, attachments: Optional[Union[str, str]] = None, from_group: Optional[bool] = None, reply_to_comment: Optional[int] = None, sticker_id: Optional[int] = None, access_key: Optional[str] = None, guid: Optional[str] = None, **kwargs: Any) -> 'responses.photos_createComment_response':
        '''Adds a new comment on the photo.'''

    async def delete(self, *, photo_id: int, owner_id: Optional[int] = None, **kwargs: Any) -> 'responses.base_ok_response':
        '''Deletes a photo.'''

    async def deleteAlbum(self, *, album_id: int, group_id: Optional[int] = None, **kwargs: Any) -> 'responses.base_ok_response':
        '''Deletes a photo album belonging to the current user.'''

    async def deleteComment(self, *, comment_id: int, owner_id: Optional[int] = None, **kwargs: Any) -> 'responses.photos_deleteComment_response':
        '''Deletes a comment on the photo.'''

    async def edit(self, *, photo_id: int, owner_id: Optional[int] = None, caption: Optional[str] = None, latitude: Optional[float] = None, longitude: Optional[float] = None, place_str: Optional[str] = None, foursquare_id: Optional[str] = None, delete_place: Optional[bool] = None, **kwargs: Any) -> 'responses.base_ok_response':
    ...
    async def editComment(self, *, comment_id: int, owner_id: Optional[int] = None, message: Optional[str] = None, attachments: Optional[Union[str, str]] = None, **kwargs: Any) -> 'responses.base_ok_response':
        '''Edits a comment on a photo.'''

    async def get(self, *, owner_id: Optional[int] = None, album_id: Optional[str] = None, photo_ids: Optional[Union[str, str]] = None, rev: Optional[bool] = None, extended: Optional[bool] = None, feed_type: Optional[str] = None, feed: Optional[int] = None, photo_sizes: Optional[bool] = None, offset: Optional[int] = None, count: int = 50, **kwargs: Any) -> 'responses.photos_get_response':
        '''Returns a list of a user's or community's photos.'''

    async def getAlbums(self, *, owner_id: Optional[int] = None, album_ids: Optional[Union[int, str]] = None, offset: Optional[int] = None, count: Optional[int] = None, need_system: Optional[bool] = None, need_covers: Optional[bool] = None, photo_sizes: Optional[bool] = None, **kwargs: Any) -> 'responses.photos_getAlbums_response':
        '''Returns a list of a user's or community's photo albums.'''

    async def getAlbumsCount(self, *, user_id: Optional[int] = None, group_id: Optional[int] = None, **kwargs: Any) -> 'responses.photos_getAlbumsCount_response':
        '''Returns the number of photo albums belonging to a user or community.'''

    async def getAll(self, *, owner_id: Optional[int] = None, extended: Optional[bool] = None, offset: Optional[int] = None, photo_sizes: Optional[bool] = None, no_service_albums: Optional[bool] = None, need_hidden: Optional[bool] = None, skip_hidden: Optional[bool] = None, count: int = 20, **kwargs: Any) -> 'responses.photos_getAll_response':
        '''Returns a list of photos belonging to a user or community, in reverse chronological order.'''

    async def getAllComments(self, *, owner_id: Optional[int] = None, album_id: Optional[int] = None, need_likes: Optional[bool] = None, offset: Optional[int] = None, count: Optional[int] = None, **kwargs: Any) -> 'responses.photos_getAllComments_response':
        '''Returns a list of comments on a specific photo album or all albums of the user sorted in reverse chronological order.'''

    async def getById(self, *, photos: Union[str, str], extended: Optional[bool] = None, photo_sizes: Optional[bool] = None, **kwargs: Any) -> 'responses.photos_getById_legacy_response':
    ...
    async def getMarketUploadServer(self, *, group_id: int, main_photo: Optional[bool] = None, crop_x: Optional[int] = None, crop_y: Optional[int] = None, crop_width: Optional[int] = None, **kwargs: Any) -> 'responses.photos_getMarketUploadServer_response':
    ...
    async def getOwnerCoverPhotoUploadServer(self, *, group_id: int, crop_x: int = 0, crop_y: int = 0, crop_x2: int = 795, crop_y2: int = 200, **kwargs: Any) -> 'responses.base_getUploadServer_response':
    ...
    async def getUserPhotos(self, *, user_id: Optional[int] = None, offset: Optional[int] = None, extended: Optional[bool] = None, sort: Optional[str] = None, count: int = 20, **kwargs: Any) -> 'responses.photos_getUserPhotos_response':
    ...
    async def move(self, *, target_album_id: int, photo_id: int, owner_id: Optional[int] = None, **kwargs: Any) -> 'responses.base_ok_response':
    ...
    async def report(self, *, owner_id: int, photo_id: int, reason: Optional[Literal[0, 1, 2, 3, 4, 5, 6]] = None, **kwargs: Any) -> 'responses.base_ok_response':
    ...
    async def restoreComment(self, *, comment_id: int, owner_id: Optional[int] = None, **kwargs: Any) -> 'responses.photos_restoreComment_response':
    ...
    async def saveOwnerCoverPhoto(self, *, hash: str, photo: str, **kwargs: Any) -> 'responses.photos_saveOwnerCoverPhoto_response':
    ...
    async def search(self, *, q: Optional[str] = None, lat: Optional[float] = None, long: Optional[float] = None, start_time: Optional[int] = None, end_time: Optional[int] = None, sort: Optional[int] = None, offset: Optional[int] = None, count: int = 100, radius: int = 5000, **kwargs: Any) -> 'responses.photos_search_response':
...
class polls:
    ...
    async def addVote(self, *, poll_id: int, answer_ids: Union[int, str], owner_id: Optional[int] = None, is_board: Optional[bool] = None, **kwargs: Any) -> 'responses.polls_addVote_response':
        '''Adds the current user's vote to the selected answer in the poll.'''

    async def create(self, *, question: Optional[str] = None, is_anonymous: Optional[bool] = None, is_multiple: Optional[bool] = None, end_date: Optional[int] = None, owner_id: Optional[int] = None, app_id: Optional[int] = None, add_answers: Optional[str] = None, photo_id: Optional[int] = None, background_id: Optional[Literal['1', '2', '3', '4', '6', '8', '9']] = None, disable_unvote: Optional[bool] = None, **kwargs: Any) -> 'responses.polls_create_response':
        '''Creates polls that can be attached to the users' or communities' posts.'''

    async def deleteVote(self, *, poll_id: int, answer_id: int, owner_id: Optional[int] = None, is_board: Optional[bool] = None, **kwargs: Any) -> 'responses.polls_deleteVote_response':
    ...
    async def getById(self, *, poll_id: int, owner_id: Optional[int] = None, is_board: Optional[bool] = None, extended: Optional[bool] = None, fields: Optional[Union[str, str]] = None, friends_count: int = 3, name_case: Literal['abl', 'acc', 'dat', 'gen', 'ins', 'nom'] = 'nom', **kwargs: Any) -> 'responses.polls_getById_response':
    ...
    async def getVoters(self, *, poll_id: int, answer_ids: Union[int, str], owner_id: Optional[int] = None, is_board: Optional[bool] = None, friends_only: Optional[bool] = None, offset: Optional[int] = None, count: Optional[int] = None, fields: Optional[Union['objects.users_fields', str]] = None, name_case: Optional[Literal['nom', 'gen', 'dat', 'acc', 'ins', 'abl']] = None, **kwargs: Any) -> 'responses.polls_getVoters_response':
        '''Returns a list of IDs of users who selected specific answers in the poll.'''

    async def savePhoto(self, *, photo: str, hash: str, **kwargs: Any) -> 'responses.polls_savePhoto_response': ...
...
class search:
    ...
    async def getHints(self, *, q: Optional[str] = None, offset: Optional[int] = None, filters: Optional[Union[str, str]] = None, fields: Optional[Union[str, str]] = None, limit: int = 9, search_global: bool = 1, **kwargs: Any) -> 'responses.search_getHints_response':
        '''Allows the programmer to do a quick search for any substring.'''

class secure:
    def __getattr__(self, __name: str) -> __VkMethod: ...

    async def addAppEvent(self, *, user_id: int, activity_id: int, value: Optional[int] = None, **kwargs: Any) -> 'responses.base_ok_response':
    ...
    async def sendNotification(self, *, message: str, user_ids: Optional[Union[int, str]] = None, user_id: Optional[int] = None, **kwargs: Any) -> 'responses.secure_sendNotification_response':
        '''Sends notification to the user.'''

    async def sendSMSNotification(self, *, user_id: int, message: str, **kwargs: Any) -> 'responses.base_ok_response':
        '''Sends 'SMS' notification to a user's mobile device.'''

    async def setCounter(self, *, counters: Optional[Union[str, str]] = None, user_id: Optional[int] = None, counter: Optional[int] = None, increment: Optional[bool] = None, **kwargs: Any) -> 'responses.base_ok_response':
        '''Sets a counter which is shown to the user in bold in the left menu.'''

class stats:
    def __getattr__(self, __name: str) -> __VkMethod: ...

    async def get(self, *, group_id: Optional[int] = None, app_id: Optional[int] = None, timestamp_from: Optional[int] = None, timestamp_to: Optional[int] = None, intervals_count: Optional[int] = None, filters: Optional[Union[str, str]] = None, stats_groups: Optional[Union[str, str]] = None, interval: Literal['all', 'day', 'month', 'week', 'year'] = 'day', extended: bool = True, **kwargs: Any) -> 'responses.stats_get_response':
        '''Returns statistics of a community or an application.'''

    async def getPostReach(self, *, owner_id: str, post_ids: Union[int, str], **kwargs: Any) -> 'responses.stats_getPostReach_response':
        '''Returns stats for a wall post.'''

    async def trackVisitor(self, *, id: str, **kwargs: Any) -> 'responses.base_ok_response': ...
...
class storage:
    ...
    async def get(self, *, key: Optional[str] = None, keys: Optional[Union[str, str]] = None, user_id: Optional[int] = None, **kwargs: Any) -> 'responses.storage_get_response':
...
class store:
    ...
    async def getProducts(self, *, type: Optional[str] = None, merchant: Optional[str] = None, section: Optional[str] = None, product_ids: Optional[Union[int, str]] = None, filters: Optional[Union[str, str]] = None, extended: bool = 0, **kwargs: Any) -> 'responses.store_getProducts_response': ...

    async def getStickersKeywords(self, *, stickers_ids: Optional[Union[int, str]] = None, products_ids: Optional[Union[int, str]] = None, all_products: Optional[bool] = None, aliases: bool = True, need_stickers: bool = True, **kwargs: Any) -> 'responses.store_getStickersKeywords_response': ...
...
class stories:
    ...
    async def delete(self, *, owner_id: Optional[int] = None, story_id: Optional[int] = None, stories: Optional[Union[str, str]] = None, **kwargs: Any) -> 'responses.base_ok_response':
        '''Allows to delete story.'''

    async def get(self, *, owner_id: Optional[int] = None, fields: Optional[Union['objects.base_user_group_fields', str]] = None, extended: bool = False, **kwargs: Any) -> 'responses.stories_get_V5113_response':
        '''Returns stories available for current user.'''

    async def getBanned(self, *, extended: Optional[bool] = None, fields: Optional[Union['objects.base_user_group_fields', str]] = None, **kwargs: Any) -> 'responses.stories_getBanned_response':
        '''Returns list of sources hidden from current user's feed.'''

    async def getById(self, *, stories: Union[str, str], fields: Optional[Union['objects.base_user_group_fields', str]] = None, extended: bool = False, **kwargs: Any) -> 'responses.stories_getById_response':
        '''Returns story by its ID.'''

    async def getPhotoUploadServer(self, *, add_to_news: Optional[bool] = None, user_ids: Optional[Union[int, str]] = None, reply_to_story: Optional[str] = None, link_text: Optional['objects.stories_upload_link_text'] = None, link_url: Optional[str] = None, group_id: Optional[int] = None, clickable_stickers: Optional[str] = None, **kwargs: Any) -> 'responses.stories_getPhotoUploadServer_response':
        '''Returns URL for uploading a story with photo.'''

    async def getReplies(self, *, owner_id: int, story_id: int, access_key: Optional[str] = None, fields: Optional[Union['objects.base_user_group_fields', str]] = None, extended: bool = False, **kwargs: Any) -> 'responses.stories_get_V5113_response':
    ...
    async def getViewers(self, *, owner_id: int, story_id: int, count: int = 100, offset: int = 0, extended: bool = 0, **kwargs: Any) -> 'responses.stories_getViewers_extended_V5115_response':
    ...
    async def save(self, *, upload_results: Union[str, str], extended: Optional[bool] = None, fields: Optional[Union[str, str]] = None, **kwargs: Any) -> 'responses.stories_save_response': ...

    async def search(self, *, q: Optional[str] = None, place_id: Optional[int] = None, latitude: Optional[float] = None, longitude: Optional[float] = None, radius: Optional[int] = None, mentioned_id: Optional[int] = None, extended: Optional[bool] = None, fields: Optional[Union[str, str]] = None, count: int = 20, **kwargs: Any) -> 'responses.stories_get_V5113_response': ...

    async def sendInteraction(self, *, access_key: str, message: Optional[str] = None, is_broadcast: bool = False, is_anonymous: bool = False, unseen_marker: bool = False, **kwargs: Any) -> 'responses.base_ok_response': ...
...
class streaming:
    ...
    async def setSettings(self, *, monthly_tier: Optional[Literal['tier_1', 'tier_2', 'tier_3', 'tier_4', 'tier_5', 'tier_6', 'unlimited']] = None, **kwargs: Any) -> 'responses.base_ok_response': ...

class users:
    def __getattr__(self, __name: str) -> __VkMethod: ...

    async def get(self, *, user_ids: Optional[Union[str, str]] = None, fields: Optional[Union['objects.users_fields', str]] = None, name_case: Optional[Literal['nom', 'gen', 'dat', 'acc', 'ins', 'abl']] = None, **kwargs: Any) -> 'responses.users_get_response':
        '''Returns detailed information on users.'''

    @overload
    async def getFollowers(self, *, fields: Union['objects.users_fields', str], user_id: Optional[int] = None, offset: Optional[int] = None, name_case: Optional[Literal['nom', 'gen', 'dat', 'acc', 'ins', 'abl']] = None, count: int = 100, **kwargs: Any) -> 'responses.users_getFollowers_fields_response': ...
    @overload
    async def getFollowers(self, *, user_id: Optional[int] = None, offset: Optional[int] = None, fields: Optional[None] = None, name_case: Optional[Literal['nom', 'gen', 'dat', 'acc', 'ins', 'abl']] = None, count: int = 100, **kwargs: Any) -> 'responses.users_getFollowers_response':
        '''Returns a list of IDs of followers of the user in question, sorted by date added, most recent first.'''

    async def getSubscriptions(self, *, user_id: Optional[int] = None, extended: Optional[bool] = None, offset: Optional[int] = None, fields: Optional[Union['objects.users_fields', str]] = None, count: int = 20, **kwargs: Any) -> 'responses.users_getSubscriptions_response':
        '''Returns a list of IDs of users and communities followed by the user.'''

    async def report(self, *, user_id: int, type: Literal['porn', 'spam', 'insult', 'advertisement'], comment: Optional[str] = None, **kwargs: Any) -> 'responses.base_ok_response':
        '''Reports (submits a complain about) a user.'''

    async def search(self, *, q: Optional[str] = None, sort: Optional[Literal[0, 1]] = None, offset: Optional[int] = None, fields: Optional[Union['objects.users_fields', str]] = None, city: Optional[int] = None, country: Optional[int] = None, hometown: Optional[str] = None, university_country: Optional[int] = None, university: Optional[int] = None, university_year: Optional[int] = None, university_faculty: Optional[int] = None, university_chair: Optional[int] = None, sex: Optional[Literal[0, 1, 2]] = None, status: Optional[Literal[0, 1, 2, 3, 4, 5, 6, 7]] = None, age_from: Optional[int] = None, age_to: Optional[int] = None, birth_day: Optional[int] = None, birth_month: Optional[int] = None, birth_year: Optional[int] = None, online: Optional[bool] = None, has_photo: Optional[bool] = None, school_country: Optional[int] = None, school_city: Optional[int] = None, school_class: Optional[int] = None, school: Optional[int] = None, school_year: Optional[int] = None, religion: Optional[str] = None, company: Optional[str] = None, position: Optional[str] = None, group_id: Optional[int] = None, from_list: Optional[Union[str, str]] = None, count: int = 20, **kwargs: Any) -> 'responses.users_search_response':
...
class utils:
    ...
    async def getLinkStats(self, *, key: str, access_key: Optional[str] = None, source: Literal['vk_cc', 'vk_link'] = 'vk_cc', interval: Literal['day', 'forever', 'hour', 'month', 'week'] = 'day', intervals_count: int = 1, extended: bool = False, **kwargs: Any) -> 'responses.utils_getLinkStats_response':
        '''Returns stats data for shortened link.'''

    async def getServerTime(self, **kwargs: Any) -> 'responses.utils_getServerTime_response':
        '''Returns the current time of the VK server.'''

    async def getShortLink(self, *, url: str, private: bool = False, **kwargs: Any) -> 'responses.utils_getShortLink_response':
...
class video:
    ...
    async def addAlbum(self, *, group_id: Optional[int] = None, title: Optional[str] = None, privacy: Optional[privacy_enum] = None, **kwargs: Any) -> 'responses.video_addAlbum_response':
        '''Creates an empty album for videos.'''

    async def addToAlbum(self, *, owner_id: int, video_id: int, target_id: Optional[int] = None, album_id: Optional[int] = None, album_ids: Optional[Union[int, str]] = None, **kwargs: Any) -> 'responses.base_ok_response': ...

    async def createComment(self, *, video_id: int, owner_id: Optional[int] = None, message: Optional[str] = None, attachments: Optional[Union[str, str]] = None, from_group: Optional[bool] = None, reply_to_comment: Optional[int] = None, sticker_id: Optional[int] = None, guid: Optional[str] = None, **kwargs: Any) -> 'responses.video_createComment_response':
    ...
    async def edit(self, *, video_id: int, owner_id: Optional[int] = None, name: Optional[str] = None, desc: Optional[str] = None, privacy_view: Optional[Union[str, str]] = None, privacy_comment: Optional[Union[str, str]] = None, no_comments: Optional[bool] = None, repeat: Optional[bool] = None, **kwargs: Any) -> 'responses.base_ok_response':
        '''Edits information about a video on a user or community page.'''

    privacy_enum = Literal['0', '1', '2', '3']
    async def editAlbum(self, *, album_id: int, title: str, group_id: Optional[int] = None, privacy: Optional[privacy_enum] = None, **kwargs: Any) -> 'responses.base_ok_response':
        '''Edits the title of a video album.'''

    async def editComment(self, *, comment_id: int, owner_id: Optional[int] = None, message: Optional[str] = None, attachments: Optional[Union[str, str]] = None, **kwargs: Any) -> 'responses.base_ok_response':
        '''Edits the text of a comment on a video.'''

    async def get(self, *, owner_id: Optional[int] = None, videos: Optional[Union[str, str]] = None, album_id: Optional[int] = None, offset: Optional[int] = None, extended: Optional[bool] = None, fields: Optional[Union[str, str]] = None, count: int = 100, **kwargs: Any) -> 'responses.video_get_response':
    ...
    async def getAlbums(self, *, owner_id: Optional[int] = None, offset: Optional[int] = None, extended: Optional[bool] = None, count: int = 50, need_system: bool = 0, **kwargs: Any) -> 'responses.video_getAlbums_response':
        '''Returns a list of video albums owned by a user or community.'''

    async def getAlbumsByVideo(self, *, owner_id: int, video_id: int, target_id: Optional[int] = None, extended: bool = 0, **kwargs: Any) -> 'responses.video_getAlbumsByVideo_response': ...

    async def getComments(self, *, video_id: int, owner_id: Optional[int] = None, need_likes: Optional[bool] = None, start_comment_id: Optional[int] = None, offset: Optional[int] = None, sort: Optional[Literal['asc', 'desc']] = None, extended: Optional[bool] = None, fields: Optional[Union[str, str]] = None, count: int = 20, **kwargs: Any) -> 'responses.video_getComments_response':
        '''Returns a list of comments on a video.'''

    async def removeFromAlbum(self, *, owner_id: int, video_id: int, target_id: Optional[int] = None, album_id: Optional[int] = None, album_ids: Optional[Union[int, str]] = None, **kwargs: Any) -> 'responses.base_ok_response': ...
    ...
    async def report(self, *, owner_id: int, video_id: int, reason: Optional[Literal[0, 1, 2, 3, 4, 5, 6]] = None, comment: Optional[str] = None, search_query: Optional[str] = None, **kwargs: Any) -> 'responses.base_ok_response':
    ...
    async def restoreComment(self, *, comment_id: int, owner_id: Optional[int] = None, **kwargs: Any) -> 'responses.video_restoreComment_response':
        '''Restores a previously deleted comment on a video.'''

    async def save(self, *, name: Optional[str] = None, description: Optional[str] = None, is_private: Optional[bool] = None, wallpost: Optional[bool] = None, link: Optional[str] = None, group_id: Optional[int] = None, album_id: Optional[int] = None, privacy_view: Optional[Union[str, str]] = None, privacy_comment: Optional[Union[str, str]] = None, no_comments: Optional[bool] = None, repeat: Optional[bool] = None, compression: Optional[bool] = None, **kwargs: Any) -> 'responses.video_save_response':
        '''Returns a server address (required for upload) and video data.'''

    filters_enum = Literal['youtube', 'vimeo', 'short', 'long']
    async def search(self, *, q: Optional[str] = None, sort: Optional[Literal[1, 2, 0]] = None, hd: Optional[int] = None, adult: Optional[bool] = None, live: Optional[bool] = None, filters: Optional[filters_enum] = None, search_own: Optional[bool] = None, offset: Optional[int] = None, longer: Optional[int] = None, shorter: Optional[int] = None, count: int = 20, extended: bool = 0, **kwargs: Any) -> 'responses.video_search_response':
...
class wall:
    ...
    async def createComment(self, *, post_id: int, owner_id: Optional[int] = None, from_group: Optional[int] = None, message: Optional[str] = None, reply_to_comment: Optional[int] = None, attachments: Optional[Union[str, str]] = None, sticker_id: Optional[int] = None, guid: Optional[str] = None, **kwargs: Any) -> 'responses.wall_createComment_response':
    ...
    async def get(self, *, owner_id: Optional[int] = None, domain: Optional[str] = None, offset: Optional[int] = None, count: Optional[int] = None, filter: Optional['objects.wall_get_filter'] = None, extended: Optional[bool] = None, fields: Optional[Union['objects.base_user_group_fields', str]] = None, **kwargs: Any) -> 'responses.wall_get_response':
        '''Returns a list of posts on a user wall or community wall.'''

    async def getById(self, *, posts: Union[str, str], extended: Optional[bool] = None, fields: Optional[Union['objects.base_user_group_fields', str]] = None, copy_history_depth: int = 2, **kwargs: Any) -> 'responses.wall_getById_legacy_response':
        '''Returns a list of posts from user or community walls by their IDs.'''

    async def getComment(self, *, comment_id: int, owner_id: Optional[int] = None, extended: Optional[bool] = None, fields: Optional[Union['objects.base_user_group_fields', str]] = None, **kwargs: Any) -> 'responses.wall_getComment_response':
        '''Returns a comment on a post on a user wall or community wall.'''

    async def getComments(self, *, owner_id: Optional[int] = None, post_id: Optional[int] = None, need_likes: Optional[bool] = None, start_comment_id: Optional[int] = None, offset: Optional[int] = None, count: Optional[int] = None, sort: Optional[Literal['asc', 'desc']] = None, preview_length: Optional[int] = None, extended: Optional[bool] = None, fields: Optional[Union['objects.base_user_group_fields', str]] = None, comment_id: Optional[int] = None, thread_items_count: int = 0, **kwargs: Any) -> 'responses.wall_getComments_response':
    ...
    async def reportPost(self, *, owner_id: int, post_id: int, reason: Optional[Literal[0, 1, 2, 3, 4, 5, 6]] = None, **kwargs: Any) -> 'responses.base_ok_response':
        '''Reports (submits a complaint about) a post on a user wall or community wall.'''

    async def repost(self, *, object: str, message: Optional[str] = None, group_id: Optional[int] = None, mute_notifications: Optional[bool] = None, mark_as_ads: bool = False, **kwargs: Any) -> 'responses.wall_repost_response':
    ...
    async def search(self, *, owner_id: Optional[int] = None, domain: Optional[str] = None, query: Optional[str] = None, owners_only: Optional[bool] = None, extended: Optional[bool] = None, fields: Optional[Union['objects.base_user_group_fields', str]] = None, count: int = 20, offset: int = 0, **kwargs: Any) -> 'responses.wall_search_response':
